...
if (number3 !== 5) {
  ...
  document.getElementById('es2').innerHTML = 5;
}
...
if (totalShoppingCart > 50) {
  ...
  document.getElementById('es51').innerHTML = 'totale da pagare' + ' ' + totalShoppingCart + '€';
}
...
var totalShoppingCart = 30;
var blackFriday = 20;
var totale = totalShoppingCart - (totalShoppingCart * blackFriday / 100);

document.getElementById('es6').innerHTML = totale;
...
if (d % 2 == 0) {
  ...
  document.getElementById('es9').innerHTML = 'è dispari';
}
